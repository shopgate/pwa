        ...
        <ToastProvider>
          ...
          <Viewport>
            ...
            <Router history={history}>
              <Route pattern={INDEX_PATH} component={routes.StartPage} transition={transition} />
              <Route pattern={PAGE_PATTERN} component={routes.Page} transition={transition} />
              <Route pattern={ROOT_CATEGORY_PATTERN} component={routes.RootCategory} transition={transition} />
              <Route pattern={CATEGORY_PATTERN} component={routes.Category} transition={transition} />
              <Route pattern={CATEGORY_FILTER_PATTERN} component={routes.Filter} transition={transition} />
              <Route pattern={ITEM_PATTERN} component={routes.Product} transition={transition} />
              <Route pattern={ITEM_GALLERY_PATTERN} component={routes.ProductGallery} transition={transition} />
              <Route pattern={ITEM_REVIEWS_PATTERN} component={routes.Reviews} transition={transition} />
              <Route pattern={ITEM_WRITE_REVIEW_PATTERN} component={routes.WriteReview} transition={transition} />
              <Route pattern={CART_PATH} component={routes.Cart} transition={transition} />
              {
                appConfig.hasFavorites
                && <Route pattern={FAVORITES_PATH} component={routes.Favorites} transition={transition} />
              }
              <Route pattern={LOGIN_PATH} component={routes.Login} transition={transition} />
              <Route pattern={SEARCH_PATTERN} component={routes.Search} transition={transition} />
              <Route pattern={SEARCH_FILTER_PATTERN} component={routes.Filter} transition={transition} />
