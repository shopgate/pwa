...
class SgTrackingAppHandler {
   ...
   * @returns {SgTrackingAppHandler} Instance of SgTrackingAppHandler
   */
  viewContent(data, restrictions) {
    SGAction.analyticsLogPageview(SgTrackingAppHandler.prepareTrackingData(data, restrictions));
    return this;
  }
  ...
  logEvent(data, restrictions) {
    SGAction.analyticsLogEvent(SgTrackingAppHandler.prepareTrackingData(data, restrictions));
    return this;
  }
  ...
  purchase(data, restrictions) {
    SGAction.analyticsLogPurchase(SgTrackingAppHandler.prepareTrackingData(data, restrictions));
    return this;
  }
  ...
  addToCart(data, restrictions) {
    SGAction.analyticsLogAddToCart(SgTrackingAppHandler.prepareTrackingData(data, restrictions));
    return this;
  }
  ...
  addedPaymentInfo(data, restrictions) {
    SGAction.analyticsLogAddedPaymentInfo(
      SgTrackingAppHandler.prepareTrackingData(data, restrictions)
    );
    return this;
  }
  ...
  search(data, restrictions) {
    SGAction.analyticsLogSearch(SgTrackingAppHandler.prepareTrackingData(data, restrictions));
    return this;
  }
...
export default new SgTrackingAppHandler();
