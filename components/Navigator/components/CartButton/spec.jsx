...
describe('<CartButton />', () => {
  it('should not be visible with prop visible set to false', () => {
    const wrapper = shallow((
      <CartButton cartProductCount={0} visible={false} activeCartRoute={false} openCart={() => {}} />
    ));
  ...
  it('should render with cartProductCount beeing set to 4', () => {
    const wrapper = shallow(<CartButton cartProductCount={4} visible activeCartRoute={false} openCart={() => {}} />);
  ...
  it('should show \'99+\' if the cart amount is higher', () => {
    const wrapper = shallow(<CartButton cartProductCount={115} visible activeCartRoute={false} openCart={() => {}} />);
  ...
  it('should transition if it has cart amount', () => {
    const wrapper = shallow(<CartButton cartProductCount={5} visible activeCartRoute={false} openCart={() => {}} />);
