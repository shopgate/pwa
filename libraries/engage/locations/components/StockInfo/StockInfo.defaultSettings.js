...
export default {
  [AVAILABILITY_TYPE_AVAILABLE]: {
    ...
    availabilityText: `product.location_stock_info.${AVAILABILITY_TYPE_AVAILABLE}`,
  ...
  [AVAILABILITY_TYPE_LIMITED_AVAILABILITY]: {
    ...
    includeInventoryBlind: false,
    includeNoRecordStores: false,
    availabilityText: `product.location_stock_info.${AVAILABILITY_TYPE_LIMITED_AVAILABILITY}`,
  ...
  [AVAILABILITY_TYPE_NOT_AVAILABLE]: {
    ...
    includeInventoryBlind: false,
    includeNoRecordStores: false,
    availabilityText: `product.location_stock_info.${AVAILABILITY_TYPE_NOT_AVAILABLE}`,
  ...
  [AVAILABILITY_TYPE_CUSTOM_AVAILABILITY]: {
    ...
    availabilityText: `product.location_stock_info.${AVAILABILITY_TYPE_CUSTOM_AVAILABILITY}`,
    availabilityTextColor: colors.error,
    allowOrderingToStore: true,
  },
