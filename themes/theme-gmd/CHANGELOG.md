...
## [v7.30.4](https://github.com/shopgate/pwa/compare/v7.30.3...v7.30.4) (2026-04-24)
...
#### :rocket: Enhancement
* [#1458](https://github.com/shopgate/pwa/pull/1458) Add support for new app event to handle links in iframes ([@fkloes](https://github.com/fkloes))

#### :bug: Bug Fix
* [#1457](https://github.com/shopgate/pwa/pull/1457) Fix fetchInventories request issues when called for too many products ([@fkloes](https://github.com/fkloes))
...
#### :house: Internal
* [#1442](https://github.com/shopgate/pwa/pull/1442) Update React to v17 and fix peer dependency issues ([@fkloes](https://github.com/fkloes))
...
#### :bug: Bug Fix
* [#1380](https://github.com/shopgate/pwa/pull/1380) Fixed bug with the camera permissions hint on the iOS theme ([@fkloes](https://github.com/fkloes))
* [#1379](https://github.com/shopgate/pwa/pull/1379) Fixed redirect handler parameters ([@fkloes](https://github.com/fkloes))
