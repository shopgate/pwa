...
const ProductInfo = ({ productId, options }) => (
  <Fragment>
    ...
    <Portal name={PRODUCT_INFO}>
      <Grid component="div" className="theme-ios11__product__header__product-info">
        <Grid.Item component="div" grow={1} className="theme-ios11__product__header__product-info__row1">
        ...
        <Grid.Item component="div" className={`${styles.priceContainer} theme-ios11__product__header__product-info__row2`}>
