...
export const HISTORY_WILL_RESET = 'HISTORY_WILL_RESET';
export const HISTORY_DID_RESET = 'HISTORY_DID_RESET';
export const OPEN_LINK = 'OPEN_LINK';
// PUSH NOTIFICATION
export const OPEN_PUSH_NOTIFICATION = 'OPEN_PUSH_NOTIFICATION';
export const SUCCESS_OPEN_PUSH_NOTIFICATION = 'SUCCESS_OPEN_PUSH_NOTIFICATION';
export const ERROR_OPEN_PUSH_NOTIFICATION = 'ERROR_OPEN_PUSH_NOTIFICATION';
// DEEP LINK
export const OPEN_DEEP_LINK = 'OPEN_DEEP_LINK';
export const SUCCESS_OPEN_DEEP_LINK = 'SUCCESS_OPEN_DEEP_LINK';
export const ERROR_OPEN_DEEP_LINK = 'ERROR_OPEN_DEEP_LINK';
